...
function SwipeButtons() {
    return (
        <div className="swipeButtons">
                ...
                <IconButton className="swipeButtons_fav"><FavoriteIcon fontSize="large" /></IconButton>
                <IconButton className="swipeButtons_flash"><FlashOnIcon fontSize="large" /></IconButton>
        </div>
    );
};
